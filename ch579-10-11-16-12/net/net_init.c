...
UINT8 IPAddr[4] = {192,168,128,15};                                              /* CH579IP地址 */
UINT8 GWIPAddr[4] = {192,168,128,11};                                              /* CH579网关 */
UINT8 IPMask[4] = {255,255,255,0};                                              /* CH579子网掩码 */

/* 网口灯定义 只针对PB口 */
UINT16 CH57xNET_LEDCONN=GPIO_Pin_2;                                                  /* 连接指示灯 PB4 */
UINT16 CH57xNET_LEDDATA=GPIO_Pin_3;                                                 /* 通讯指示灯 PB7 */ 
